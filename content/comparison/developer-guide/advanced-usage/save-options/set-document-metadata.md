...
curl -v "https://api.groupdocs.cloud/v2.0/comparison/comparisons" ^
  ...
  -H "Accept: application/json" ^
  -H "Authorization: Bearer %JWT_TOKEN%" ^
  -d "{\"SourceFile\":{\"FilePath\":\"source_files/word/source.docx\"},\"TargetFiles\":[{\"FilePath\":\"target_files/word/target.docx\"}],\"OutputPath\":\"output/result.docx\",\"Settings\":{\"CloneMetadata\":\"FileAuthor\",\"MetaData\":{\"Author\":\"Tom\",\"Company\":\"GroupDocs\",\"LastSaveBy\":\"Jack\"}}}"
```
{{< /tab >}} {{< tab "Response" >}}
