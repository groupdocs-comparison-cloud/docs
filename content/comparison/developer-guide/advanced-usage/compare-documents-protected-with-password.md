...
curl -v "https://api.groupdocs.cloud/v2.0/comparison/comparisons" ^
  ...
  -H "Accept: application/json" ^
  -H "Authorization: Bearer %JWT_TOKEN%" ^
  -d "{\"SourceFile\":{\"FilePath\":\"source_files\\\\word\\\\source_protected.docx\",\"Password\":\"1231\"},\"TargetFiles\":[{\"FilePath\":\"target_files\\\\word\\\\target_protected.docx\",\"Password\":\"5784\"}],\"OutputPath\":\"output/result.docx\"}"
```
