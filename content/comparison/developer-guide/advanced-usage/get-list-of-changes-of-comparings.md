...
# Step 2: Get document information (Comparison changes)
...
curl -v "https://api.groupdocs.cloud/v2.0/comparison/changes" ^
  ...
  -H "Accept: application/json" ^
  -H "Authorization: Bearer %JWT_TOKEN%" ^
  -d "{\"SourceFile\":{\"FilePath\":\"source_files/word/source.docx\"},\"TargetFiles\":[{\"FilePath\":\"target_files/word/target.docx\"}]}"
```
